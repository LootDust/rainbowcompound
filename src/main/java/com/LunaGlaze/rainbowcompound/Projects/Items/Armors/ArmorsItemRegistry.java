...
public class ArmorsItemRegistry {
    ...
    public static final RegistryObject<Item> obsidianitehelmet = ITEMS.register("obsidianite_helmet", () ->
            new CRCArmorItem(CRCArmorMaterials.Obsidianite, EquipmentSlot.HEAD, (new Item.Properties().tab(RainbowcompoundTab.group).fireResistant())));
    public static final RegistryObject<Item> obsidianitechestplate = ITEMS.register("obsidianite_chestplate", () ->
            new CRCArmorItem(CRCArmorMaterials.Obsidianite, EquipmentSlot.CHEST, (new Item.Properties().tab(RainbowcompoundTab.group).fireResistant())));
    public static final RegistryObject<Item> obsidianiteleggings = ITEMS.register("obsidianite_leggings", () ->
            new CRCArmorItem(CRCArmorMaterials.Obsidianite, EquipmentSlot.LEGS, (new Item.Properties().tab(RainbowcompoundTab.group).fireResistant())));
    public static final RegistryObject<Item> obsidianiteboots = ITEMS.register("obsidianite_boots", () ->
            new CRCArmorItem(CRCArmorMaterials.Obsidianite, EquipmentSlot.FEET, (new Item.Properties().tab(RainbowcompoundTab.group).fireResistant())));
    public static final RegistryObject<Item> rainbowhelmet = ITEMS.register("rainbow_helmet", () ->
            new CRCArmorItem(CRCArmorMaterials.RAINBOW, EquipmentSlot.HEAD, (new Item.Properties().tab(RainbowcompoundTab.group).fireResistant().rarity(Rarity.UNCOMMON))));
    public static final RegistryObject<Item> rainbowchestplate = ITEMS.register("rainbow_chestplate", () ->
            new CRCArmorItem(CRCArmorMaterials.RAINBOW, EquipmentSlot.CHEST, (new Item.Properties().tab(RainbowcompoundTab.group).fireResistant().rarity(Rarity.UNCOMMON))));
    public static final RegistryObject<Item> rainbowleggings = ITEMS.register("rainbow_leggings", () ->
            new CRCArmorItem(CRCArmorMaterials.RAINBOW, EquipmentSlot.LEGS, (new Item.Properties().tab(RainbowcompoundTab.group).fireResistant().rarity(Rarity.UNCOMMON))));
    public static final RegistryObject<Item> rainbowboots = ITEMS.register("rainbow_boots", () ->
            new CRCArmorItem(CRCArmorMaterials.RAINBOW, EquipmentSlot.FEET, (new Item.Properties().tab(RainbowcompoundTab.group).fireResistant().rarity(Rarity.UNCOMMON))));
